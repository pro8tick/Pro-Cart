...
import { createOrderAsync } from "../../redux/features/order/orderSlice";
...
const CheckOut = () => {
  ...
  const totalAmount = products.reduce(
    (amount, items) => discountedPrice(items.product) * items.quantity + amount,
    0
  );
  ...
  return (
    <>
      ...
      {currentOrder?.id && currentOrder.paymentMethod === "card" && (
        <Navigate to={`/stripe-checkout`} replace={true}></Navigate>
      )}
      {currentOrder?.id && currentOrder.paymentMethod === "cash" && (
        <Navigate
          to={`/order-success/${currentOrder.id}`}
          replace={true}
        ></Navigate>
      )}
      <div className="mx-auto mt-24 mb-24 max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-3">
            <form
              ...
              onSubmit={handleSubmit((data) => {
                dispatch(
                  updateUser({ ...user, addresses: [...user.addresses, data] })
                );
                reset();
              })}
            >
              ...
              <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                ...
                <div className="border-t border-gray-200 px-2 py-6 sm:px-6">
                  ...
                  <div className="mt-6">
                    <div
                      onClick={handleOrder}
                      className="cursor-pointer flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-500"
                    >
                      Order Now
                    </div>
                  </div>
